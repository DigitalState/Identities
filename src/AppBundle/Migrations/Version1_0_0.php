...
class Version1_0_0 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE app_individual_bu (individual_id INT NOT NULL, bu_id INT NOT NULL, INDEX IDX_BD1ED898AE271C0D (individual_id), INDEX IDX_BD1ED898E0319FBC (bu_id), PRIMARY KEY(individual_id, bu_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE app_individual_bu ADD CONSTRAINT FK_BD1ED898AE271C0D FOREIGN KEY (individual_id) REFERENCES app_individual (id)');
        $this->addSql('ALTER TABLE app_individual_bu ADD CONSTRAINT FK_BD1ED898E0319FBC FOREIGN KEY (bu_id) REFERENCES app_bu (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_individual_bu DROP FOREIGN KEY FK_BD1ED898E0319FBC');
        $this->addSql('ALTER TABLE app_staff_bu DROP FOREIGN KEY FK_8C89CE59E0319FBC');
        $this->addSql('ALTER TABLE app_individual_bu DROP FOREIGN KEY FK_BD1ED898AE271C0D');
        ...
        $this->addSql('DROP TABLE app_individual_bu');
