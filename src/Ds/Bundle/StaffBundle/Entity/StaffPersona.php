...
use Ds\Bundle\StaffBundle\Attribute\Accessor;
 ...
 * @ApiResource(
 *      attributes={
 *          "filters"={"ds.staff_persona.search", "ds.staff_persona.search_translation", "ds.staff_persona.date", "ds.staff_persona.order"},
