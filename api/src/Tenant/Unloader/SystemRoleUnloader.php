...
/**
 * Class SystemRoleUnloader
 */
final class SystemRoleUnloader implements Unloader
{
    /**
    ...
    {
        $builder = $this->entityManager->getRepository(SystemRole::class)->createQueryBuilder('e');
        $builder
            ->delete()
