...
Feature: Edit accesses
  ...
  Scenario: Edit an access
    ...
    And I send a "PUT" request to "/accesses/15239742-553e-4e56-9656-36f7c3dca7d4" with body:
    """
    {
  ...
  Scenario: Edit an access's read-only properties
    ...
    And the JSON node "uuid" should be equal to the string "15239742-553e-4e56-9656-36f7c3dca7d4"
